 ...
 * |--------+------+------+------+------+------| Caps |           | Ctrl |------+------+------+------+------+--------|
 * | LShift |Z/Ctrl|   X  |   C  |   V  |   B  |      |           | +Shf |   N  |   M  |   ,  |   .  |//Ctrl| RShift |
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   |Grv/L1|  '"  |AltShf| Left | Right|                                       | Left | Down |  Up  |Right | ~L1  |
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,-------------.
 *                                        | Esc  | LGui |       | Alt  |Ctrl/Esc|
 *                                 ,------|------|------|       |------+--------+------.
 *                                 |      |      | Home |       | PgUp |        |      |
...
[BASE] = KEYMAP(  // layer 0 : default
        ...
        CTL_T(SFT_T(KC_NO)),  KC_N,         KC_M,           KC_COMM,  KC_DOT,   CTL_T(KC_SLSH),     KC_RSFT,
...
[SYMB] = KEYMAP(
       ...
       KC_TRNS,KC_EXLM,KC_AT,  KC_LBRACKET,KC_RBRACKET,KC_BSLASH,KC_TRNS,
       KC_TRNS,KC_HASH,KC_DLR, KC_LPRN,KC_RPRN,KC_GRAVE,
       KC_TRNS,KC_PERC,KC_CIRC,KC_MINUS,KC_QUOTE,KC_TILD,KC_TRNS,
